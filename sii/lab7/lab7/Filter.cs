...
namespace lab7
{
    public class Filter
    {
        ...
        public List<Func<Pet, bool, bool>> Predicates { get; private set; } = [];
        ...
        public void SetConditionFilter(bool or, bool not, int condI)
        {
            ulong act = not ? 0u : 1u;
            if (or)
                Predicates.Add((pet, res) => res || (((pet.Conditions >> condI) & 1) == act));
            else
                Predicates.Add((pet, res) => res && (((pet.Conditions >> condI) & 1) == act));
        }
        public void SetColorFilter(bool or, bool not, int colI)
        {
            ulong act = not ? 0u : 1u;
            if (or)
                Predicates.Add((pet, res) => res || (((pet.Color >> colI) & 1) == act));
            else
                Predicates.Add((pet, res) => res && (((pet.Color >> colI) & 1) == act));
        }
        ...
        {
            if (or)
                Predicates.Add((pet, res) => res || (regex.IsMatch(pet.Type.Name.ToLower()) ^ not));
            else
                Predicates.Add((pet, res) => res && (regex.IsMatch(pet.Type.Name.ToLower()) ^ not));
        }
        ...
        {
            if (or)
                Predicates.Add((pet, res) => res || (regex.IsMatch(pet.Specie.Name.ToLower()) ^ not));
            else
                Predicates.Add((pet, res) => res && (regex.IsMatch(pet.Specie.Name.ToLower()) ^ not));
        }
        ...
        {
            if (or)
                Predicates.Add((pet, res) => res || (regex.IsMatch(pet.Breed.Name.ToLower()) ^ not));
            else
                Predicates.Add((pet, res) => res && (regex.IsMatch(pet.Breed.Name.ToLower()) ^ not));
        }
        ...
        {
            if (or)
                Predicates.Add((pet, res) => res || predicate(pet.Size));
            else
                Predicates.Add((pet, res) => res && predicate(pet.Size));
        }
        ...
        {
            if (or)
                Predicates.Add((pet, res) => res || predicate(pet.Age));
            else
                Predicates.Add((pet, res) => res && predicate(pet.Age));
        }
        ...
        {
            if (or)
                Predicates.Add((pet, res) => res || predicate(pet.AvgAge));
            else
                Predicates.Add((pet, res) => res && predicate(pet.AvgAge));
        }
        ...
        {
            if (or)
                Predicates.Add((pet, res) => res || (pet.Active ^ not));
            else
                Predicates.Add((pet, res) => res && (pet.Active ^ not));
        }
        ...
        {
            if (or)
                Predicates.Add((pet, res) => res || (pet.Vacinied ^ not));
            else
                Predicates.Add((pet, res) => res && (pet.Vacinied ^ not));
        }

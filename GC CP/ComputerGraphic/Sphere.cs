...
namespace ComputerGraphic
{
    ...
    internal class Sphere : SceneObject
    {
        ...
        public Sphere(Vector3 Position, float radius, Color color, string name) : base(name)
        {
        ...
        public override Trace Intersection(Ray ray, LightSource l)
        {
            ...
            float i = l.intens * Vector3.Dot(norm, lv);

            return new(inters, Intense(i));
        }

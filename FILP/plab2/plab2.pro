...
sumOwnershipsPrice(S, P) :- sumOwnershipsPriceHelp(S, building, P1), sumOwnershipsPriceHelp(S, area, P2), 
sumOwnershipsPriceHelp(S, water_transport, P3), sumOwnershipsPriceHelp(S, car, P4), P = P1 + P2 + P3 + P4.
